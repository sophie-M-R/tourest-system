         ...
         <el-row :gutter="10">
            ...
            <el-col :xs="24" :sm="12" :md="8" :lg="8">
              <el-form-item label="出生日期" prop="birthday">
                <el-date-picker type="date" v-model="temp.birthday" />
              </el-form-item>
            </el-col>
            <el-col :xs="24" :sm="12" :md="8" :lg="8">
...
<script>
import {loanCreate} from '@/api/article'
//性别
const sexOptions = [
    ...
    methods: {
      submitForm(formName) {
        this.$refs[formName].validate((valid) => {
          if (valid) {
            // alert('submit!');
            /* this.$http.post("loan/create",this.temp)
            .then(res=>{
              console.log(res);
              this.$router.push('/input-manager/index')
            }).catch(error=>{
              console.log(error)
            }) */
